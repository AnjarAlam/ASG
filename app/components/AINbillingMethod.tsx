...
useEffect(() => {
  ...
  const accountBase = gstRate > 0 ? accountWithGst / (1 + gstRate / 100) : accountWithGst;
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    setFormData((prev) => ({
                      ...
                      weight: {
                        ...prev.weight,
                        lines: prev.weight.lines.map((l: any, i: number) =>
                  ...
                  <button
                    ...
                    onClick={() => {
                      setFormData((prev) => ({
                        ...
                        weight: {
                          ...prev.weight,
                          lines: prev.weight.lines.filter((_: any, i: number) => i !== index),
                        },
                      }));
                    }}
      ...
      <button
        ...
        onClick={() => {
          setFormData((prev) => ({
            ...
            weight: {
              ...prev.weight,
              lines: [...(prev.weight?.lines || []), { loading: "", rate: "", gstRate: "18" }],
            },
          }));
        }}
  ...
  <label className="absolute left-4 -top-2 px-2 bg-gray-800 text-xs font-medium 
                  ...
                  <button
                    ...
                    onClick={() => {
                      setFormData((prev) => ({
                        ...
                        different: {
                          ...prev.different,
                          materials: prev.different.materials.filter((_: any, i: number) => i !== index),
                        },
                      }));
                    }}
      ...
      <button
        ...
        onClick={() => {
          setFormData((prev) => ({
            ...
            different: {
              ...prev.different,
              materials: [...(prev.different?.materials || []), { name: "", quantity: "", rate: "" }],
            },
          }));
        }}
        className="w-full py-3.5 px-6 bg-violet-900/30 hover:bg-violet-900/50 
